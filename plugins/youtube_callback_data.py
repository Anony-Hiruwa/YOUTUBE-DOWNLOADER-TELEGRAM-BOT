...
async def catch_youtube_dldata(c, q):
    ...
    await q.edit_message_reply_markup(
        InlineKeyboardMarkup([[InlineKeyboardButton("ඩව්න් වෙනෝ 🤭🤤\nDownloading...", callback_data="down")]]))
...
async def send_file(c, q, med, filename):
    ...
    try:
        await q.edit_message_reply_markup(
            InlineKeyboardMarkup([[InlineKeyboardButton("ඔයාට එවන ගමන්... 🤤🤭\nUploading...🤤🤭", callback_data="down")]]))
